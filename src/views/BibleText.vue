...
<template>
    Text biblic
    <div class="relative bg-brand-honeydew p-3">
        <p class="text-xl"><span class=" text-sm text-gray-500">4 </span>Cât priveşte legăturile cu oamenii, eu, după
    ...
    <div v-if="isOpen" class="mt-12 p-3 bg-gray-200 rounded">
            <p>Duis ultrices accumsan lorem, non ultricies dolor dapibus sit amet. Praesent dignissim finibus tempus.
            </p>
        </div>
